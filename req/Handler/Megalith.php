			...
			else
			{
				...
				if (Configuration::$instance->showTitle[Configuration::ON_SUBJECT])
					...
					(
						...
						Configuration::$instance->showComment[Configuration::ON_SUBJECT] ? "{$_->commentCount}/{$_->responseCount}" : "0/0",
			...
			if ($c->showTitle[Configuration::ON_SUBJECT])
				...
				(
					...
					(
						...
						$c->showPoint[Configuration::ON_COMMENT] ? "{$_->commentCount}/{$_->responseCount}" : "0",
