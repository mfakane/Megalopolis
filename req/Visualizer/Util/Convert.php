...
<body>
	...
	<section class="convert" id="convert">
		<?if (is_null($d)): ?>
			<form action="" method="get" id="form">
				...
				<p>
					<label><input type="checkbox" id="allowOverwrite" name="allowOverwrite" value="yes" />更新日時が変換前と同一の作品の再変換を許可する</label>
				</p>
				<p>
	...
	<script>
		megalopolis.convert.action = '<?+Visualizer::actionHref("util", "convert.json") ?>';
